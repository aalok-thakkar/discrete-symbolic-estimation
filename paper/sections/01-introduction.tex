...
unguided sampling.  \algname{} (\emph{Adaptive Symbolic Importance
  Partitioning}) maintains a \emph{frontier}: a tree whose leaves
...
\algname{}'s data-dependent stopping rule, strictly tightening the
...
\begin{enumerate}
\item \emph{The \algname{} algorithm and its correctness proof.}  We
  introduce \algname{} and prove that its reported interval $[L,U]$
...
\item \emph{Implementation and evaluation.}  We implement \algname{}
...
\Cref{sec:algorithm} presents \algname{} and proves
